...
/**
 	이건 xml파일의 요소들을 추출할때 사용하는 패키지. 나중에 참고하세요.
 */
...
public class DOMParsing {
	public void parse() {
		...
		try {
			...
			Node firstBookNode = bookNodeList.item(0);	//	첫번쨰 아이템
			Element bookElement = (Element)firstBookNode;
			
			//	속성 접근방법1: 앨리먼트 객체의 getAttribute()메서드 이용
			...
			System.out.println("titleElement.getTagName() => "+titleElement.getTagName());	//title
