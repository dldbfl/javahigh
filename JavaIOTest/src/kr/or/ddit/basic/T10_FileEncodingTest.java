...
/*
 	OutputStreamWriter객체 -> OutputStrem(바이트기반의 출력용 객체)를
 ...
 */
	...
	public static void main(String[] args) throws IOException {
		...
		//	out_utf8.text파일은 'utf-8' 인코딩 방식으로
		// out_ansi.text파일은 'ms949' 인코딩 방식으로 저장한다.
		...
		//	문자출력 스트림인 Writert로 변환시키는 보조스트림이다.
