...
//		Map<String, String> map = new HashMap<>();
		if (combobox.getValue() == null || combobox.getValue().equals("")) {
			...
			list = FXCollections.observableArrayList(Postnumservice.getSearchdong(tfid.getText()));
			
			tableView.setItems(list);
		} else if (combobox.getValue().equals("우편번호")) {
				
			list = FXCollections.observableArrayList(Postnumservice.getSearchzipcode(tfid.getText()));
